...
const ContactHelpTopBar = ({ logoutHandler, user, setShowHelpContentPage }) => {
        ...
        >
          {Object.keys(user).length === 0 ? (
            ...
            <div>
              ...
              <div>
                <NavLink
                  style={{ fontSize: '14px', marginLeft: '65px', marginTop: '5px' }}
                  className="text-black"
                  to="/app"
                >
                  <p style={{ marginLeft: '75px' }} className="text-secondary">
                    View Dashboard
                  </p>
                </NavLink>
              </div>
          ...
          <a
            href="https://youtube.com/playlist?list=PLc8DW6Kg4VqbOzm3uQ_5JhKn-AnfgYru7"
            style={{ color: 'black', marginLeft: '20px', fontSize: '15px', marginTop: '20px', fontWeight: '600' }}
            target="_blank"
            rel="noopener"
          >
            Video Tutorials
          ...
          {Object.keys(user).length && (
            <p
              ...
              style={{ marginLeft: '20px', fontSize: '15px', marginTop: '20px', fontWeight: '600' }}
            >
              Sign Out
            </p>
          )}
