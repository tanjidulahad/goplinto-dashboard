...
describe('<Img />', () => {
  it('should match the snapshot', () => {
    const renderedComponent = renderer.create(<Img src="http://example.com/test.jpg" alt="test" />).toJSON()
  ...
  it('should not adopt an invalid attribute', () => {
    const { container } = render(<Img src="http://example.com/test.jpg" attribute="test" alt="test" />)
